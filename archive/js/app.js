(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".mini-catalog__slider")) new core(".mini-catalog__slider", {
            ...
            if (document.querySelector(".product-main__slider")) {
                const swiperMini = new core(".product-mini__slider", {
                    observeParents: true,
                    slidesPerView: 4,
                    spaceBetween: 1,
                    direction: "vertical",
            ...
            async function formSend(e) {
                ...
                if (error === 0) {
                    ...
                    if (response.ok) {
                        ...
                        modules_flsModules.popup.close("#popup");
                    } else {
                        alert("Ошибка");
                        form.classList.remove("_sending");
                        modules_flsModules.popup.close("#popup");
